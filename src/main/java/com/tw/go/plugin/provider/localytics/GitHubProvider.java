package com.tw.go.plugin.provider.localytics;
...
public class GitHubProvider extends DefaultProvider {
    public static final String PLUGIN_ID = "localytics.pr.status";
    public static final String GITHUB_PR_POLLER_PLUGIN_ID = "github-material";
